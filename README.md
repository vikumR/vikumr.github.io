...
## Work Experience
### Senior Software Engineer (07/2023 - present) | 99X
...
- Enhanced a microservice with **Project Reactor**, and **Spring Webflux**, to generate PDFs for various domain concepts like Orders, Invoices, etc. Developed middleware to integrate the Order Management System (OMS) with this microservice through **webhooks**, supporting order creation, document generation, and email delivery via REST APIs. Enabled the client to automatically generate detailed invoice reports for Sales Orders cutting down manual document creation by 100%.
